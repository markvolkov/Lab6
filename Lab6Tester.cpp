...
//
    ...
    arrayList->insertAtEnd(2);
    arrayList->insertAt(3, 1);
    arrayList->insertAt(4, 1);
    arrayList->insertAt(5, 1);
    arrayList->insertAt(6, 1);
    arrayList->removeValueAt(1);

    findTester();
    //TODO:
    rangeErrorTests(*arrayList);

    std::cout << arrayList->toString() << std::endl;
